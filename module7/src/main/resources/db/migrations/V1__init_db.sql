...
CREATE INDEX IF NOT EXISTS products_categories_product_idx ON products_categories(product_id);
CREATE INDEX IF NOT EXISTS products_categories_categories_idx ON products_categories(category_id);
